...
export const AUDIT_SHEET_TYPES = {
  technical: { label: 'Technical Audit', color: 'bg-teal-100 text-teal-800 dark:bg-teal-900 dark:text-teal-200' },
  content: { label: 'Content Audit', color: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200' },
  competitor: { label: 'Competitor Analysis', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900 dark:text-amber-200' },
