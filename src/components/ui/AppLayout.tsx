  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-[#f2f4f0]'}`}>
      <div className="p-4">
        {/* Top bar */}
        <div
          className={`sticky top-4 z-40 rounded-3xl px-3 md:px-5 py-2.5 flex items-center gap-2 md:gap-3 mb-4 shadow-sm ${
        ...
        >
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span
              className={`text-base font-bold hidden xl:block ${
          ...
          {/* Search */}
          <div className="flex-1 relative min-w-0 hidden lg:block">
            <Search
            ...
            <input
              ...
              className={`w-full pl-11 pr-4 py-2 rounded-full text-sm outline-none transition-colors ${
                isDarkMode
          ...
          <button
            className={`hidden xl:flex w-9 h-9 rounded-full items-center justify-center transition-colors shrink-0 ${
              isDarkMode
                ? 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
            }`}
          ...
          <button
            onClick={logout}
            className={`hidden sm:flex w-9 h-9 rounded-full items-center justify-center transition-colors shrink-0 ${
              isDarkMode
                ? 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
            }`}
          ...
          {/* User */}
          <div
            className={`hidden md:flex items-center gap-2 pl-2 border-l shrink-0 ${
              isDarkMode ? 'border-gray-700' : 'border-gray-100'
            }`}
          >
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center text-white font-semibold text-xs">
              {initials}
            </div>
          </div>
          ...
          <button
            ...
            className={`md:hidden w-9 h-9 rounded-full flex items-center justify-center transition-colors shrink-0 ${
              isDarkMode
                ? 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
            }`}
